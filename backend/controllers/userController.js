...
const followUnfollowUser = async (req, res) => {
    try {
        ...
        if (isFollowing) {
            // Unfollow
            // Modify currentUser FOLLOWING and userToModify's FOLLOWERS
...
const updateUser = async (req, res) => {
    ...
    try {
        ...
        if (profilePic){
            // destroys previous uploaded profile pic
			if (user.profilePic) {
                // isolates image id and destroys it    
